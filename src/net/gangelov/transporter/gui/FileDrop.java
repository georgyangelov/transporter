 ...
 * <p/>
 * To use this class, construct a new <tt>net.gangelov.transporter.gui.FileDrop</tt> by passing
 ...
 *      new net.gangelov.transporter.gui.FileDrop( myPanel, new net.gangelov.transporter.gui.FileDrop.Listener()
 *      {   public void filesDropped( java.io.File[] files )
 *          {
 *              // handle file drop
 *              ...
 *          }   // end filesDropped
 *      }); // end net.gangelov.transporter.gui.FileDrop.Listener
 * </pre></code>
 * <p/>
...
public class FileDrop
{
    ...
    final Listener listener)
    {
        ...
        {   // Make a drop listener
            ...
            {   public void dragEnter( java.awt.dnd.DropTargetDragEvent evt )
                {       log( out, "net.gangelov.transporter.gui.FileDrop: dragEnter event." );
                    ...
                    if( isDragOk( out, evt ) )
                    {
                        ...
                        {   javax.swing.JComponent jc = (javax.swing.JComponent) c;
                            ...
                            log( out, "net.gangelov.transporter.gui.FileDrop: normal border saved." );
                            jc.setBorder( dragBorder );
                            log( out, "net.gangelov.transporter.gui.FileDrop: drag border set." );
                        }   // end if: JComponent

                        // Acknowledge that it's okay to enter
                        //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                        evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY );
                        log( out, "net.gangelov.transporter.gui.FileDrop: event accepted." );
                    }   // end if: drag ok
                    else
                    {   // Reject the drag event
                        evt.rejectDrag();
                        log( out, "net.gangelov.transporter.gui.FileDrop: event rejected." );
                ...
                {   log( out, "net.gangelov.transporter.gui.FileDrop: drop event." );
                    try
                    {   // Get whatever was dropped
                        ...
                        if (tr.isDataFlavorSupported (java.awt.datatransfer.DataFlavor.javaFileListFlavor))
                        {
                            ...
                            log( out, "net.gangelov.transporter.gui.FileDrop: file list accepted." );
                            ...
                            log( out, "net.gangelov.transporter.gui.FileDrop: drop complete." );
                        }   // end if: file list
                        else // this section will check for a reader flavor.
                        {
                            ...
                            for (int zz = 0; zz < flavors.length; zz++) {
                                if (flavors[zz].isRepresentationClassReader()) {
                                    ...
                                    //evt.acceptDrop ( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                                    evt.acceptDrop(java.awt.dnd.DnDConstants.ACTION_COPY);
                                    log(out, "net.gangelov.transporter.gui.FileDrop: reader accepted.");
                            ...
                            if(!handled){
                                log( out, "net.gangelov.transporter.gui.FileDrop: not a file list or reader - abort." );
                                evt.rejectDrop();
                            }
                    ...
                    {   log( out, "net.gangelov.transporter.gui.FileDrop: IOException - abort:" );
                        io.printStackTrace( out );
                        evt.rejectDrop();
                    }   // end catch IOException
                    catch (java.awt.datatransfer.UnsupportedFlavorException ufe)
                    {   log( out, "net.gangelov.transporter.gui.FileDrop: UnsupportedFlavorException - abort:" );
                    ...
                    finally
                    {
                        ...
                        {   javax.swing.JComponent jc = (javax.swing.JComponent) c;
                            ...
                            log( out, "net.gangelov.transporter.gui.FileDrop: normal border restored." );
                        }   // end if: JComponent
                    }   // end finally
                }   // end drop

                public void dragExit( java.awt.dnd.DropTargetEvent evt )
                {   log( out, "net.gangelov.transporter.gui.FileDrop: dragExit event." );
                    // If it's a Swing component, reset its border
                    if( c instanceof javax.swing.JComponent )
                    {   javax.swing.JComponent jc = (javax.swing.JComponent) c;
                        jc.setBorder( normalBorder );
                ...
                {   log( out, "net.gangelov.transporter.gui.FileDrop: dropActionChanged event." );
                    // Is this an acceptable drag event?
                    if( isDragOk( out, evt ) )
                    {   //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
                        evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY );
        ...
        {   log( out, "net.gangelov.transporter.gui.FileDrop: Drag and drop is not supported with this JVM" );
    ...
    {   // Static Boolean
     ...
     private static File[] createFileArray(BufferedReader bReader, PrintStream out)
     {
        try {
            ...
            log(out, "net.gangelov.transporter.gui.FileDrop: IOException");
        }
        return new File[0];
     }
     // END 2007-09-12 Nathan Blomquist -- Linux (KDE/Gnome) support added.
    ...
    private void makeDropTarget( final java.io.PrintStream out, final java.awt.Component c, boolean recursive )
    {
        ...
        {   e.printStackTrace();
            log(out, "net.gangelov.transporter.gui.FileDrop: Drop will not work due to previous error. Do you have another listener attached?" );
        }   // end catch

        // Listen for hierarchy changes and remove the drop target when the parent gets cleared out.
        c.addHierarchyListener( new java.awt.event.HierarchyListener()
        {   public void hierarchyChanged( java.awt.event.HierarchyEvent evt )
            {   log( out, "net.gangelov.transporter.gui.FileDrop: Hierarchy changed." );
                java.awt.Component parent = c.getParent();
                if( parent == null )
                {   c.setDropTarget( null );
                    log( out, "net.gangelov.transporter.gui.FileDrop: Drop target cleared from component." );
                }   // end if: null parent
                else
                {   new java.awt.dnd.DropTarget(c, dropListener);
                    log( out, "net.gangelov.transporter.gui.FileDrop: Drop target added to component." );
    ...
    {   boolean ok = false;
        ...
        if( out != null )
        {   if( flavors.length == 0 )
                log( out, "net.gangelov.transporter.gui.FileDrop: no data flavors." );
    ...
    {   // Make sure we support dnd.
        if( supportsDnD() )
        {   log( out, "net.gangelov.transporter.gui.FileDrop: Removing drag-and-drop hooks." );
            c.setDropTarget( null );
            if( recursive && ( c instanceof java.awt.Container ) )
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */
     ...
     * <code><pre>
     *      public class MyClass implements net.gangelov.transporter.gui.FileDrop.Listener
     *      ...
     *      public void filesDropped( java.io.File[] files )
     *      {
     *          ...
...
}   // end class net.gangelov.transporter.gui.FileDrop
